...
fetch("ContentsEsami.php").then(OnResponseEsami).then(creazione_contenuti);
...
//TODO::FUNZIONA CHE MOSTRA I DETTAGLI
...
function aggiungiPreferiti(event) {
    const notchoosed = "http://localhost:63342/hw1/img/outline_add_black_24dp.png";
    const choosed = "http://localhost:63342/hw1/img/outline_remove_black_24dp.png";
...
function aggiungiPrenotazioni(event) {
    ...
    json = btoa(json);
    fetch("addPrenotazioni.php?json=" + json);
}
